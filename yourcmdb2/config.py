"""
yourCMDB2 appconfig module

This is the module for accessing the configuration file of yourCMDB2
...
class FileConfig(object):
    """Class for handling the yourCMDB2 configuration file.
    This class handles the yourCMDB2 configuration file.
    """

    def __init__(self):
        """Creates a new config object from the config file /../etc/yourcmdb2.conf"""
         # get directory name
        basedir = os.path.dirname(os.path.abspath(__file__))
        self.__filename = basedir + "/../etc/yourcmdb2.conf"
